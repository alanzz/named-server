...
function Query(arg) {
        ...
        this._qdCount = arg.qdCount; // Question section count
        // this._anCount = arg.anCount || 0; // Answer section count
        // this._nsCount = arg.nsCount || 0; // Authority section count
        // this._srCount = arg.srCount || 0; // Additional section count
...
Query.prototype.encode = function encode() {
        ...
        var toPack = {
                header: {
                        ...
                        nsCount: this._authority.length,
                        srCount: this._additional.length
                },
...
Query.prototype.addAuthority = function(name, record, ttl) {
        ...
        this._authority.push(answerAuthority);
};
...
Query.prototype.addAdditional = function(name, record, ttl) {
        ...
        this._additional.push(answerAdditional);
};
